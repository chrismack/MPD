 ...
 */
public class LoginView extends AppCompatActivity implements LoaderCallbacks<Cursor>, LoginContract.ILoginView {
            ...
            Snackbar.make(mEmailView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
                    .setAction(android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            requestPermissions(new String[]{READ_CONTACTS}, presenter.getReqReadContacts());
                        }
                    });
        } else {
            requestPermissions(new String[]{READ_CONTACTS}, presenter.getReqReadContacts());
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == presenter.getReqReadContacts()) {
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !this.presenter.isPasswordValid(password)) {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            cancel = true;
        } else if (!this.presenter.isEmailValid(email)) {
